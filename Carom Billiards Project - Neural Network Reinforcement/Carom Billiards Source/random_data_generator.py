...
class Ball:
    ...
    def __init__(self, size = 70, position = (int(right/2),int(bottom/2)), color = (0,0,0), speed = 0.0, angle = 0):
        self.size =  size
        self.x = position[0]
        self.y = position[1]
        self.color = color
...
np.save('training_data/train_inputs_v3', train_inputs)
np.save('training_data/train_targets_v3', train_targets)
